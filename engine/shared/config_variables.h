...
MACRO_CONFIG_INT(ClPlusSpinbot, cl_plus_spinbot, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable spinbot")
MACRO_CONFIG_INT(ClPlusSpinbotSpeed, cl_plus_spinbot_speed, 50, 1, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Spinbot rotation speed")
MACRO_CONFIG_INT(ClPlusSpinbotDistance, cl_plus_spinbot_distance, 100, 10, 500, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Spinbot aim distance")
MACRO_CONFIG_INT(ClPlusSpinbotSilent, cl_plus_spinbot_silent, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Silent spinbot (doesn't move crosshair visually)")
MACRO_CONFIG_INT(ClPlusSpinbotAutoFire, cl_plus_spinbot_autofire, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto fire when using spinbot")

MACRO_CONFIG_INT(ClPlusAutoAim, cl_plus_autoaim, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable auto aim")
MACRO_CONFIG_INT(ClPlusAutoAimRange, cl_plus_autoaim_range, 500, 0, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto aim maximum range")
MACRO_CONFIG_INT(ClPlusAutoAimAutofire, cl_plus_autoaim_autofire, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto fire when target acquired")
MACRO_CONFIG_INT(ClPlusSilentAim, cl_plus_silent_aim, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Silent aim (doesn't move crosshair visually)")

MACRO_CONFIG_INT(ClPlusPet, cl_plus_pet, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable pet")
MACRO_CONFIG_INT(ClPlusPetTarget, cl_plus_pet_target, 0, 0, 63, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Pet target player ID")
MACRO_CONFIG_INT(ClPlusPetPositionLine, cl_plus_pet_position_line, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show line to pet target")
MACRO_CONFIG_INT(ClPlusPetTrail, cl_plus_pet_trail, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show pet trail")
MACRO_CONFIG_INT(ClPlusPetTrailRadius, cl_plus_pet_trail_radius, 50, 10, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Pet trail radius")
MACRO_CONFIG_COL(ClPlusPetTrailColor, cl_plus_pet_trail_color, 65535, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Pet trail color")
MACRO_CONFIG_INT(ClPlusRenderPetLikeTee, cl_plus_render_pet_like_tee, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Render pet as tee instead of sprite")

MACRO_CONFIG_INT(ClPlusTeeTrail, cl_plus_tee_trail, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show tee trail")
MACRO_CONFIG_INT(ClPlusTeeTrailRadius, cl_plus_tee_trail_radius, 50, 10, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Tee trail radius") 
MACRO_CONFIG_COL(ClPlusTeeTrailColor, cl_plus_tee_trail_color, 65535, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Tee trail color")

MACRO_CONFIG_INT(ClPlusMagicParticles, cl_plus_magic_particles, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show magic particles")
MACRO_CONFIG_INT(ClPlusMagicParticlesVariant, cl_plus_magic_particles_variant, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Alternative magic particles style")

MACRO_CONFIG_INT(ClPlusRecording, cl_plus_recording, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Record movements")
MACRO_CONFIG_INT(ClPlusPlaying, cl_plus_playing, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Play recorded movements")
MACRO_CONFIG_INT(ClPlusKilled, cl_plus_killed, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Kill command used in recording")
MACRO_CONFIG_STR(ClPlusMapRecordsPath, cl_plus_map_records_path, 256, "records", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Path to save map records")

MACRO_CONFIG_INT(ClPlusSnapline, cl_plus_snapline, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show lines to other players")
MACRO_CONFIG_INT(ClPlusBox, cl_plus_box, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show boxes around other players")
MACRO_CONFIG_INT(ClPlusDrawPredictedPos, cl_plus_draw_predicted_pos, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show predicted positions")
MACRO_CONFIG_INT(ClPlusRenderBluePathLine, cl_plus_render_blue_path_line, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show blue path line")

MACRO_CONFIG_INT(ClPlusAntiGoingFreezeRange, cl_plus_anti_going_freeze_range, 32, 1, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Range to check for freeze tiles")

MACRO_CONFIG_INT(ClPlusFakePingEnabled, cl_plus_fake_ping_enabled, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable fake ping (negative)")
MACRO_CONFIG_INT(ClPlusFakePingEnabled1, cl_plus_fake_ping_enabled1, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable fake ping (positive)")
MACRO_CONFIG_INT(ClPlusFakePing, cl_plus_fake_ping, 0, 0, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Amount of fake ping to add/subtract")
MACRO_CONFIG_INT(ClPlusFreezePing, cl_plus_freeze_ping, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Freeze ping at current value")

MACRO_CONFIG_INT(ClPlusTripleDummyFly, cl_plus_triple_dummy_fly, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable triple dummy fly mode")
MACRO_CONFIG_INT(ClPlusStabilizer, cl_plus_stabilizer, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable movement stabilizer")

MACRO_CONFIG_INT(ClPlusWasRecording, cl_plus_was_recording, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Internal: Was recording last tick")

MACRO_CONFIG_INT(ClMoonWalk, cl_moonwalk, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable moonwalk movement")
MACRO_CONFIG_INT(ClMoonWalkSpeed, cl_moonwalk_speed, 10, 1, 50, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Speed of moonwalk movement")
MACRO_CONFIG_INT(ClPlusFlyBot, cl_plus_flybot, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable fly bot")
MACRO_CONFIG_INT(ClPlusPredictionTestBot, cl_plus_prediction_test_bot, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable prediction test bot for map testing")
MACRO_CONFIG_INT(ClPlusAntiFallingFreeze, cl_plus_anti_falling_freeze, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable anti falling freeze")
MACRO_CONFIG_INT(ClPlusAntiGoingFreeze, cl_plus_anti_going_freeze, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable anti going freeze")
MACRO_CONFIG_INT(ClPlusAntiGoingFreezeType, cl_plus_anti_going_freeze_type, 1, 1, 2, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Anti going freeze type")
MACRO_CONFIG_INT(ClPlusSelectedRecord, cl_plus_selected_record, -1, -1, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Selected record index")
MACRO_CONFIG_INT(ClPlusWhatsMyPing, cl_plus_whats_my_ping, 0, 0, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Current ping value")

MACRO_CONFIG_INT(ClPlusHammerCopy, cl_plus_hammer_copy, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable hammer copy")
MACRO_CONFIG_INT(ClPlusAutoWallshot, cl_plus_auto_wallshot, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable auto wallshot")
